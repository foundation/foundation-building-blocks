...
Check out the [Foundation Docs](https://get.foundation/sites/docs) to learn about how flexible our forms are for creating different layouts. It works perfectly with the grid to meet all your form needs.
